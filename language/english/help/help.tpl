<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/planet/admin/index.php"
           title="Back to the administration of Planet"> Planet
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of Planet">
        </a></h1>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">This module is Feed Planet For XOOPS, a XML Feed Fetching and Parsing Management module<br> <br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/planet-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/planet-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModulesArchive/planet" target="_blank">GitHub</a><br><br>
